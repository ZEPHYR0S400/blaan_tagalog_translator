...
class _DictionaryScreenState extends State<DictionaryScreen> {
  ...
  final List<DictionaryEntry> _entries = [
    ...
    DictionaryEntry(
      ...
      translation: 'Suman',
      definition:
          'isang matamis na panghimagas o meryenda na gawa sa malagkit na bigas, niluto sa gata at asukal, at binalot sa dahon ng saging.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Malem',
      translation: 'Sumbat',
      definition:
          'pagpuna o pagtuligsa sa isang tao sa pamamagitan ng di-kanais-nais na komento tungkol sa kanyang aksyon na hindi ayon sa inaasahan o pamantayan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tmulen',
      translation: 'Sumbong',
      definition:
          ' pahayag o salaysay hinggil sa maling kilos o hindi pagkakasundo na nangangailangan ng pansin o aksyon.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Dyandi',
      translation: 'Sumpa',
      definition:
          ' isang malalim na pangako o panunumpa na may kasunduan, o masamang kapalaran na ipinapataw bilang parusa, ginagamit sa mga ritwal o okasyon.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Banyandi',
      translation: 'Sumpain',
      definition:
          'ang akto ng pagbigkas ng mga salita o parirala upang magdulot ng kapahamakan o ipahayag ang matinding galit sa pamamagitan ng paghangad ng masama sa isang tao.',
      partOfSpeech: 'Pandiwa',
    ),
    DictionaryEntry(
      word: 'Snitong',
      translation: 'Sundo',
      definition:
          'isang tao na may responsibilidad na maghatid o magsamang ligtas ng isang indibidwal mula sa isang lugar patungo sa iba.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Andog',
      translation: 'Sundot',
      definition:
          ' kilos ng bahagyang pagtulak o paghawak sa bagay o tao gamit ang daliri o patulis na bagay, upang akitin ang pansin o bilang biro.',
      partOfSpeech: 'Pangngalan / Pang-uri',
    ),
    DictionaryEntry(
      word: 'Suket',
      translation: 'Sungay',
      definition:
          'matigas at tulis na buto sa ulo ng ilang hayop tulad ng usa at toro, karaniwang pares at ginagamit sa pagtanggol, na may kakayahang tumubo muli kapag naputol.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Labe',
      translation: 'Sungit',
      definition:
          'ang pagiging hindi magiliw o mahirap lapitan, ipinapakita sa pamamagitan ng mahigpit o matigas na pag-uugali at pananalita.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Sakuf',
      translation: 'Sunog',
      definition:
          ' tumutukoy sa pagbabago ng kulay, anyo, o lasa ng isang bagay dahil sa matinding init o apoy, na nagreresulta sa pagkasira nito.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Fungas',
      translation: 'Supot',
      definition:
          'isang lalagyan o maliit na sisidlan na karaniwang yari sa plastik o tela, ginagamit sa pagbitbit, pagdala, o pag-iimbak ng ibat ibang bagay.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gunsi',
      translation: 'Susi',
      definition:
          'isang maliit na instrumentong metal na ginagamit upang buksan o isara ang kandado at magsimula ng makina ng sasakyan o kagamitan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'So / Su',
      translation: 'Suso',
      definition:
          'dalawang malambot na bahagi sa dibdib ng mga babae at ilang lalaki, naglalaman ng glandulang mamarya para sa paggawa ng gatas at simbolo ng pagiging ina.',
      partOfSpeech: 'Pangngalan',
    ),
    ...
    DictionaryEntry(
      ...
      translation: 'Suso',
      definition:
          'isang maliit na hayop na may matigas na bahay sa likod, kilala sa mabagal na paggalaw at protektadong katawan, matatagpuan sa lupa o tubig.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Taha',
      translation: 'Taas',
      definition:
          ' sukat o kalagayan ng pagiging mula sa ibabaw patungo sa pinakatuktok na bahagi, o ang pagiging malayo sa lupa.',
      partOfSpeech: 'Pangngalan / Pang-uri',
    ),
    DictionaryEntry(
      word: 'Mabu',
      translation: 'Taba',
      definition:
          'substansiyang maputi o kulay krema sa katawan ng tao o hayop, ginagamit bilang reserba ng enerhiya, o tawag sa taong may malaking katawan dahil dito.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Limun',
      translation: 'Tabon',
      definition:
          ' isang tambak ng lupa o materyales para sa pagpupuno o pagsasara ng mga butas, hukay, o puwang sa lupa at iba pang ibabaw.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Antel',
      translation: 'Tadtad',
      definition:
          'ginawang maliliit na piraso sa pamamagitan ng paghihiwa o pagputol nang maliit.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Neaen / Sabla an',
      translation: 'Taga',
      definition:
          'unlapi na nagpapahiwatig ng pinanggalingan, lokasyon, o taong may partikular na aksyon o propesyon.',
      partOfSpeech: '',
    ),
    DictionaryEntry(
      word: 'Gal mimo Nuleh',
      translation: 'Tagapagpatawa',
      definition:
          ' isang aksyon o pangungusap na nagpapakita ng kasiyahan o tuwa, nagdudulot ng saya o katatawanan, at nagreresulta sa pagtawa.',
      partOfSpeech: 'Pang-abay',
    ),
    DictionaryEntry(
      word: 'Tamdak',
      translation: 'Tagas',
      definition:
          'isang hindi sinasadyang pangyayari kung saan may likidong lumalabas mula sa butas o siwang ng sisidlan o lalagyan tulad ng tubig o langis.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Ammifu',
      translation: 'Tagdilim',
      definition:
          'oras o panahon sa pagitan ng hapon at gabi kung saan unti-unting nawawala ang liwanag ng araw at nagsisimula ang kadiliman.',
      partOfSpeech: '',
    ),
    DictionaryEntry(
      word: 'Atkilil',
      translation: 'Tagilid',
      definition:
          ' nakasandal o hindi pantay ang posisyon at nasa panganib o may pag-aalinlangan sa kalagayan o legalidad.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'To minit',
      translation: 'Tag-init',
      definition:
          ' panahon na may mataas na temperatura, madalas ang paglitaw ng araw, bihira ang ulan, at karaniwang bakasyon ng mga mag-aaral.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Too atnoh',
      translation: 'Tag-ulan',
      definition:
          'panahon mula Hunyo hanggang Nobyembre sa Pilipinas na may madalas na pag-ulan, pagkulog, at mataas na tsansa ng bagyo, nagdudulot ng malamig na klima at pagbaha.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gafles',
      translation: 'Tagos',
      definition:
          ' tumutukoy sa kakayahang dumaan o tumagos sa isang bagay nang walang hadlang at nagpapahiwatig ng malalim o matalas na epekto sa isipan o damdamin.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Klafang',
      translation: 'Tagpi',
      definition:
          'isang paraan ng pag-aayos ng sira o punit sa pamamagitan ng pagdaragdag ng panibagong materyal upang matakpan ang nasirang bahagi at maibalik sa kabuuan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Siteh',
      translation: 'Tagpo',
      definition:
          ' lugar o bahagi ng kwento/dula kung saan nagkikita o nagaganap ang mahahalagang pangyayari para sa isang layunin.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gumne',
      translation: 'Tahanan',
      definition:
          'estrukturang lugar kung saan naninirahan ang isang pamilya o indibidwal, ginagamit bilang pangunahing lugar ng pamumuhay.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tbel',
      translation: 'Tahi',
      definition:
          'paraan ng pagdugtong ng mga bahagi gamit ang sinulid at karayom, o proseso ng paghilom ng sugat sa pamamagitan ng paglalapat ng mga gilid nito.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Matnak',
      translation: 'Tahimik',
      definition:
          'walang o kaunting ingay lamang at nasa estado ng kapayapaan, walang gulo o kaguluhan.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Tmaul',
      translation: 'Tahol',
      definition:
          ' tunog o ingay na ginagawa ng aso upang ipahayag ang damdamin o makipag-usap, halimbawa dahil sa galit, tuwa, o takot.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gubamtas',
      translation: 'Takal',
      definition:
          ' isang sukat o pamamaraan sa pagtutuos ng dami ng likido o butil, karaniwang gamit ang lalagyan o kasangkapan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Mila',
      translation: 'Takbo',
      definition:
          'isang mabilis na paraan ng paggalaw na higit sa paglakad, ginagamit sa palakasan o pagtakas, o ang direksyon ng pangyayari o kaisipan sa isang tiyak na landas.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Safang',
      translation: 'Takip',
      definition:
          ' bagay na ginagamit para isara, protektahan, o hindi pahintulutang makapasok o makalabas ang anuman sa ibabaw o loob ng sisidlan o lalagyan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Snafang',
      translation: 'Takipan',
      definition:
          'isang gawain ng pagtatago o paglilihim ng kapintasan at pagbibigay proteksyon dito upang hindi ito mapansin o mahusgahan ng iba.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Saklawat',
      translation: 'Takipsilim',
      definition:
          'ang oras o panahon sa huli ng hapon sa pagitan ng paglubog ng araw at bago magdilim nang tuluyan, kung saan unti-unting nawawala ang liwanag.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Liko',
      translation: 'Takot',
      definition:
          'nadarama dahil sa alalahanin o panganib na maaaring magdulot ng hindi kanais-nais na pangyayari, pinsala, o kapahamakan.',
      partOfSpeech: 'Pang-uri / Pang-abay',
    ),
    DictionaryEntry(
      word: 'Tubad',
      translation: 'Talbos',
      definition:
          ' bahagi ng halaman na bagong usbong mula sa sanga o tangkay, karaniwang nagiging dahon.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Kanfulong',
      translation: 'Talento',
      definition:
          'likas at natatanging kakayahan o abilidad sa isang larangan o gawain na nagpapakita ng kahusayan at bihira sa maraming tao.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Ikat',
      translation: 'Tali',
      definition:
          'manipis na hibla o pisi, yari sa abaka, plastik, o ibang materyales, ginagamit sa pagbubuklod, pagkakabit, o pag-iipon ng mga bagay.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gare',
      translation: 'Talino',
      definition:
          'kakayahang umunawa, matuto, at mag-isip nang mabilis at malalim, pati na rin ang likas na galing sa sining, agham, at iba pang larangan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Talam / Gamban',
      translation: 'Talim',
      definition:
          'ang matulis na bahagi ng kutsilyo, espada, o anumang kasangkapan na ginagamit sa pagputol, paghiwa, o pagtusok.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Too',
      translation: 'Tama',
      definition:
          'angkop o akma sa isang sitwasyon, walang kamalian at pagpapatibay o pagsang-ayon sa isang sinabi o ginawa.',
      partOfSpeech: 'Pangngalan / Pang-uri',
    ),
    DictionaryEntry(
      word: 'Malweh',
      translation: 'Tamad',
      definition:
          'hindi masigasig o aktibo sa paggawa ng mga gawain, may ugaling umiwas sa pagkilos, at mas pinipiling magpahinga kahit hindi kinakailangan.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Fadno',
      translation: 'Tampo',
      definition:
          'isang paraan ng hindi direktang pagpapahayag ng pagka-disgusto o sama ng loob sa pamamagitan ng pagiging tahimik at pag-iwas sa pakikipag-usap.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Adweng',
      translation: 'Tanaw',
      definition:
          'nakikita o naaabot ng tingin mula sa kinatatayuan, hindi nakatago, at maaaring pagmasdan nang direkta.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Danweng',
      translation: 'Tanawin',
      definition:
          'pagmasid o pag-obserba sa isang lugar, bagay, o pangyayari mula sa malayo nang hindi malapitan.',
      partOfSpeech: 'Pandiwa',
    ),
    DictionaryEntry(
      word: 'Atnamgid',
      translation: 'Tandayan',
      definition:
          'isang istraktura o kagamitan sa paghabi ng tela, kung saan inilalagay at ihanay ang mga sinulid na patayo at pahalang upang lumikha ng ibat ibang disenyo at pattern.',
      partOfSpeech: '',
    ),
    DictionaryEntry(
      word: 'Tangal',
      translation: 'Tangan',
      definition:
          'nasa kamay o pag-iingat ng isang tao; hawak o bitbit ng isang indibidwal.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Tangal / Nabeh',
      translation: 'Tangay',
      definition:
          'nawalan ng kontrol o napadala nang labis sa damdamin o interes sa isang bagay o pangyayari.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Dnawat',
      translation: 'Tanggap',
      definition:
          'kinikilala, pinapayagan bilang wasto, at inaako nang walang pagtutol sa isang grupo, samahan, o kategorya.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Adnawat',
      translation: 'Tanggapan',
      definition:
          'isang opisina o entidad sa pamahalaan o pribadong sektor na lugar ng opisyal na gawain, serbisyo, transaksyon, at komunikasyon para sa publiko.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Nang / La maye',
      translation: 'Tanggi',
      definition:
          'aksyon ng hindi pagtanggap o pag-ayaw sa alok, suhestiyon, o panukala, bilang pagpapahayag ng hindi pagsang-ayon.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Ansen',
      translation: 'Tanggol',
      definition:
          'aksyon o hakbang ng pagprotekta sa sarili o sa iba laban sa banta o panganib upang hindi mapinsala o masaktan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Alturo',
      translation: 'Tanghali',
      definition:
          'oras sa gitna ng araw, pagkatapos ng umaga at bago ang hapon, na karaniwang oras ng pahinga at pagkain ng pangalawang pagkain sa araw.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Knaan Alturo',
      translation: 'Tanghalian',
      definition:
          'ang pagkain na kinakain pagkatapos ng almusal at bago ang hapunan, karaniwang hinahain sa gitna ng umaga at hapon bilang pangalawang pagkain ng araw.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Bantak',
      translation: 'Tangka',
      definition:
          'isang balak o layunin na may kasamang pagsisikap at hakbangin upang makamit ang isang partikular na resulta o mithiin.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Faleh',
      translation: 'Tanim',
      definition:
          'ang paglilinang ng mga halaman o produktong agrikultural mula sa lupa gamit ang buto, o ang pagpapanatili ng negatibong damdamin o saloobin laban sa isang tao.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Toh',
      translation: 'Tao',
      definition:
          'nilalang na Homo sapiens, may kakayahang mag-isip, makaramdam, gumawa ng desisyon, makipagtalastasan, bumuo ng lipunan, at may kultura at sibilisasyon sa ibat ibang bahagi ng mundo.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Alnakob',
      translation: 'Taob',
      definition:
          'nangangahulugang baligtad o nakabaliktad ang posisyon, o isang kalagayan kung saan ang isang bagay o sitwasyon ay lubhang nagbago, karaniwan sa hindi inaasahang paraan, na nagreresulta sa pagkawala o pagkasira.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Fali',
      translation: 'Taon',
      definition:
          'yunit ng oras na binubuo ng labindalawang buwan, ginagamit sa pagsukat ng haba mula sa isang kaganapan hanggang sa kasalukuyan at yugto sa buhay na may karanasan at pagbabago.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Anlek',
      translation: 'Tapak',
      definition:
          'ang marka o galaw ng paa sa lupa o sahig na nangyayari kapag lumalakad, tumatayo, o lumilipat ng lugar.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gu amlek',
      translation: 'Tapakan',
      definition:
          'ang paglalagay o pag-apak ng paa sa ibabaw ng anumang bagay o sahig, maaaring sinasadya o hindi.',
      partOfSpeech: 'Pandiwa',
    ),
    DictionaryEntry(
      word: 'Labe',
      translation: 'Tapang',
      definition:
          'ang katangian ng pagiging matatag sa harap ng panganib o kahirapan, o ang masidhi at malakas na kalidad ng lasa sa pagkain o inumin.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Frangkam',
      translation: 'Tapatin',
      definition:
          'maging tapat sa isang tao; sabihin ang totoo sa isang tao; maging prangka sa isang tao.',
      partOfSpeech: '',
    ),
    DictionaryEntry(
      word: 'Tipalo',
      translation: 'Tapilok',
      definition:
          'isang hindi sinasadyang pag-twist o pag-ikot ng bukung-bukong habang naglalakad o tumatakbo, na maaaring magdulot ng pagkawala ng balanse, sakit, o pinsala.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Lafin',
      translation: 'Tapis',
      definition:
          'isang piraso ng tela na ginagamit bilang pantakip sa katawan upang protektahan ang damit sa gawaing bahay o bilang tuwalya sa kusina.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Bat',
      translation: 'Tapon',
      definition:
          'isang bagay na ginagamit bilang pangharang sa butas ng sisidlan upang maiwasan ang paglabas ng likido o hangin.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Fnge',
      translation: 'Tapos',
      definition:
          'ang panahon o hudyat na nagmamarka ng pagwawakas ng isang pangyayari, gawain, serye, o hanay ng mga kaganapan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Nsef',
      translation: 'Tapyas',
      definition:
          'isang maliit na piraso o bahagi na natanggal mula sa isang mas malaking bagay dahil sa pagputol o pagbawas, lumilitaw sa pagbabago ng orihinal nitong anyo.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Langen',
      translation: 'Taranta',
      definition:
          'nababahala, nalilito, at hindi mapakali dahil sa biglaang pangyayari, problema, o matinding pressure, nawawalan ng kakayahang mag-isip nang maayos.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Amgal nawa',
      translation: 'Tatag',
      definition:
          'ang kalidad ng pagiging matibay, hindi nasusugatan o napapagod, at kakayahang manatiling buo sa kabila ng mga pagsubok.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Dad toh',
      translation: 'Tau-Tauhan',
      definition:
          'isang bagay o imahe na ginawa at ginagamit para kamukha at kumilos na parang tao, kontrolado ng iba, at ginagamit sa palabas o bilang dekorasyon.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Muleh',
      translation: 'Tawa',
      definition:
          'ang pagpapahayag ng kasiyahan o saya sa pamamagitan ng malakas na pagngiti o paglikha ng tunog mula sa bibig, na nagdudulot ng aliw o libangan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tloh',
      translation: 'Tawag',
      definition:
          'pangalan o katawagan para sa isang tao, bagay, lugar, konsepto, o ang paggamit ng boses para makipag-ugnayan.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Nuleh',
      translation: 'Tawanan',
      definition:
          'ang pagpapahayag ng saya, katuwaan, o aliw sa pamamagitan ng pagngiti o paghalakhak bilang reaksyon sa isang sitwasyon, biro, o pangyayari.',
      partOfSpeech: 'Pandiwa',
    ),
    DictionaryEntry(
      word: 'Mifal',
      translation: 'Tawid',
      definition:
          'ang proseso ng paglipat o pag-akyat/baba sa isang bagay upang makarating mula sa isang gilid patungo sa kabilang gilid ng kalsada, tulay, o hadlang.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Atmaya',
      translation: 'Taya',
      definition:
          'sa laro, ang itinalagang maghanap sa mga nagtatago; o ang napiling mananagot sa pagbabayad para sa grupo.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gitoh',
      translation: 'Tayo',
      definition:
          'ang kalagayan o posisyon sa lipunan at ang pag-aangat ng sarili mula sa pagkakaupo o pagkahiga patungo sa pagiging nakatindig.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tarag',
      translation: 'tayo',
      definition:
          'panghalip na ginagamit bilang pamalit sa pangalan ng grupo, kasama ang nagsasalita, na nagsasaad ng pagkakaisa o pagsasama.',
      partOfSpeech: 'Pangngalan / Panghalip',
    ),
    DictionaryEntry(
      word: 'Mdatah',
      translation: 'Tayog',
      definition:
          'sukat o kalagayan ng pagiging mataas ng isang bagay o lugar mula sa ibaba hanggang sa pinakatuktok nito kumpara sa kapaligiran.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Falnas',
      translation: 'Tela',
      definition:
          'isang materyal na yari sa magkakaugnay na hibla tulad ng cotton, lana, seda, o synthetic, ginagamit sa paggawa ng damit, kurtina, at iba pang produkto.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Lufo',
      translation: 'Tigdas',
      definition:
          'isang nakakahawang sakit na viral, karaniwang umaapekto sa mga bata, may sintomas ng mataas na lagnat, ubo, sipon, mapupulang pantal sa katawan, at pamamaga ng glandula.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Gwanta',
      translation: 'Tiis',
      definition:
          'ang kakayahang harapin, tanggapin, at lagpasan ang mga hirap, sakit, at pagsubok sa buhay nang may katatagan ng loob at walang reklamo.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Mew',
      translation: 'Tikbalang',
      definition:
          'isang nilalang mula sa mitolohiyang Pilipino na may ulo ng kabayo at katawan ng tao, kilala sa pagliligaw sa mga biyahero mula sa kanilang landas.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tilew',
      translation: 'Tikim',
      definition:
          'gawain ng pagsubok o pagsuri sa lasa ng pagkain o inumin sa pamamagitan ng dila upang malaman ang lasa.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Lanfi',
      translation: 'Tiklop',
      definition:
          'paraan ng paggawa sa isang bagay na nagiging mas maayos o maliit sa pamamagitan ng pagyupi o pagpapatong ng isang bahagi nito sa iba.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: 'Tikam',
      translation: 'Tikom',
      definition:
          'hindi bukas at walang espasyong pagitan, kung saan ang mga bagay ay magkakadikit at walang puwang na makikita.',
      partOfSpeech: 'Pang-uri',
    ),
    DictionaryEntry(
      word: 'Stikam',
      translation: 'Tikop',
      definition:
          'ang kabuuang espasyo o lugar na nakapalibot sa isang pook o bagay, kasama ang kalagayan ng mga elemento nito tulad ng hangin, tubig, at lupa.',
      partOfSpeech: 'Pangngalan',
    ),
    ...
    DictionaryEntry(
      ...
      translation: 'Tila',
      definition:
          'nagpapahiwatig ng hindi tiyak na pagkakatulad, pagkakahawig, o impresyon ngunit hindi sigurado.',
      partOfSpeech: 'Pang-abay',
    ),
    DictionaryEntry(
      word: 'Uten',
      translation: 'Tilapya',
      definition:
          'isang uri ng isda na madaling itanim at alagaan sa palaisdaan, matibay, kayang mabuhay sa ibat ibang klase ng tubig, at ginagamit bilang masarap na pagkain.',
      partOfSpeech: 'Pangngalan',
    ),
    DictionaryEntry(
      word: '',
